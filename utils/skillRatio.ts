const DarkCommando = 186 / 10
const GravityCrash = 900 / 10
const CelestialStrike = (skillNum: number) =>
  (550 / 10) * (1.5 + 0.05 * skillNum)
const Scythe = (attr: number) =>28.5 + (30 * attr / 100) //
const StaffOfAgony = (attr: number) => 48 + (15 * attr) / 100 //
...
const FireBlessing = 1000 / 20 //
const WaterBlessing = 1000 / 20 //
